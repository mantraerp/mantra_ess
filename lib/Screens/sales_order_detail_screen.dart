...
class SalesOrderDetailScreen extends StatefulWidget {
  ...
  const SalesOrderDetailScreen({Key? key, required this.salesOrderName})
      : super(key: key);

  @override
  State<SalesOrderDetailScreen> createState() =>
...
class _SalesOrderDetailScreenState extends State<SalesOrderDetailScreen> {
  ...
  Future<void> _fetchSalesOrderDetail() async {
    setState(() {
      _isLoading = true;
      _hasError = false;
    });
        ...
        child: Column(
          ...
          children: [
            ...
            _navCard(
              context,
              title: "Items",
              subtitle: "View all items in this Sales Order",
