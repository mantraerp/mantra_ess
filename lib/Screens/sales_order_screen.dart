...
class SalesOrderListScreen extends StatefulWidget {
  ...
  @override
  State<SalesOrderListScreen> createState() =>
...
// Check if From Date is after To Date
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final poData = (data["data"] != null && data["data"]["sales_orders"] != null)
        ...
        setState(() {
          _salesOrders.addAll(poResponse.data);
        ...
        setState(() {
          _hasError = true;
          _errorMessage =
          "Failed to fetch sales orders (${response.statusCode})";
          _isLoading = false;
        });
      }
    } catch (e) {
