...
const String URLOTPVerification  = SUB_BASE_URL+"erp_mobile.api.login.verify_code";

const String URLGetMenu  = SUB_BASE_URL+"erp_mobile.api.masterdata.check_serial_no";